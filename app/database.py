...
ALTER TABLE recordings ADD COLUMN IF NOT EXISTS auto BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recordings ADD COLUMN IF NOT EXISTS auto_trigger TEXT;
ALTER TABLE recordings ADD COLUMN IF NOT EXISTS camera_id BIGINT;
